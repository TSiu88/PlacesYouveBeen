...
#### _Journal of Places Visited, 03.11.2020_
...
This application was made for Epicodus Intro to Programming and C#/React course.  The program locally keeps track of entries of cities visited, person, how long they stayed, and journal notes.  Uses MVC structure and routing between pages.
...
2. Clone the [repository](https://github.com/TSiu88/PlacesYouveBeen.git) from my [GitHub page](https://github.com/TSiu88)
